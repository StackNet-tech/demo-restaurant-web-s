  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Events Section */}
        <div id="events" className="grid md:grid-cols-2 gap-2">
          {/* Wine Tasting Evening Card */}
          <div className="relative bg-black p-20 py-10 rounded-lg h-[400px] w-[500px] flex flex-col justify-between">
            ...
            <button className="text-black bg-yellow-500 py-2 px-4 rounded font-medium">Details</button>
          </div>
          
          {/* Live Music Night Card */}
          <div className="relative bg-black px-20 py-10 rounded-lg h-[400px] w-[500px] flex flex-col justify-between">
